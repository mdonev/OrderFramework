...
namespace OpenOrderFramework.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            ViewBag.CategoryDrinks = sortOrder == "Category" ? "category_drinks" : "Category";
            ViewBag.CategoryFood = sortOrder == "Category" ? "category_food" : "Category";
            ...
            //var selected = Request.QueryString["selectedOption"];
